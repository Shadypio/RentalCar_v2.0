...
import com.mygroup.rentalcar.config.JwtAuthenticationEntryPoint;
import com.mygroup.rentalcar.config.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                ...
                .authorizeRequests().antMatchers("http://localhost:8080/api/customers/validateLogin"
